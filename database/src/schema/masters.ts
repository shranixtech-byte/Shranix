...
// 1. COMPANIES
// ═════════════════════════════════════════════════════════
export const sqliteCompanies = sqliteTableBase(
  'shranix_companies',
  {
    ...sqliteBase,
    ...
    pan: sqliteText('pan'),
    cin: sqliteText('cin'),
    licenseNo: sqliteText('license_no'),
    pesticidesLicense: sqliteText('pesticides_license'),
    seedsLicense: sqliteText('seeds_license'),
    cottonLicense: sqliteText('cotton_license'),
    fertilizerLicense: sqliteText('fertilizer_license'),
    retailLicense: sqliteText('retail_license'),
    logo: sqliteText('logo'),
    stamp: sqliteText('stamp'),
    digitalSignature: sqliteText('digital_signature'),
    invoiceSignature: sqliteText('invoice_signature'),
    emailLogo: sqliteText('email_logo'),
    invoiceFooter: sqliteText('invoice_footer'),
    qrLogo: sqliteText('qr_logo'),
...
export const pgCompanies = pgTableBase(
  'shranix_companies',
  {
    ...pgBase,
    ...
    pan: pgText('pan'),
    cin: pgText('cin'),
    licenseNo: pgText('license_no'),
    pesticidesLicense: pgText('pesticides_license'),
    seedsLicense: pgText('seeds_license'),
    cottonLicense: pgText('cotton_license'),
    fertilizerLicense: pgText('fertilizer_license'),
    retailLicense: pgText('retail_license'),
    logo: pgText('logo'),
    stamp: pgText('stamp'),
    digitalSignature: pgText('digital_signature'),
    invoiceSignature: pgText('invoice_signature'),
    emailLogo: pgText('email_logo'),
    invoiceFooter: pgText('invoice_footer'),
    qrLogo: pgText('qr_logo'),
...
// 2. FINANCIAL YEARS
// ═════════════════════════════════════════════════════════
export const sqliteFinancialYears = sqliteTableBase(
  'shranix_financial_years',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgFinancialYears = pgTableBase(
  'shranix_financial_years',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// 3. BRANCHES
// ═════════════════════════════════════════════════════════
export const sqliteBranches = sqliteTableBase(
  'shranix_branches',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgBranches = pgTableBase(
  'shranix_branches',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// 4. WAREHOUSES
// ═════════════════════════════════════════════════════════
export const sqliteWarehouses = sqliteTableBase(
  'shranix_warehouses',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgWarehouses = pgTableBase(
  'shranix_warehouses',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// 5. UNITS
// ═════════════════════════════════════════════════════════
export const sqliteUnits = sqliteTableBase(
  'shranix_units',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgUnits = pgTableBase(
  'shranix_units',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// 6. CATEGORIES
// ═════════════════════════════════════════════════════════
export const sqliteCategories = sqliteTableBase(
  'shranix_categories',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgCategories = pgTableBase(
  'shranix_categories',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// ═════════════════════════════════════════════════════════
export const sqliteBrands = sqliteTableBase(
  'shranix_brands',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgBrands = pgTableBase(
  'shranix_brands',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// 8. TAX GROUPS
// ═════════════════════════════════════════════════════════
export const sqliteTaxGroups = sqliteTableBase(
  'shranix_tax_groups',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgTaxGroups = pgTableBase(
  'shranix_tax_groups',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// 9. GST RATES
// ═════════════════════════════════════════════════════════
export const sqliteGSTRates = sqliteTableBase(
  'shranix_gst_rates',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgGSTRates = pgTableBase(
  'shranix_gst_rates',
  {
    ...pgBase,
    name: pgText('name').notNull(),

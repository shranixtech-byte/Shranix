...
// ═════════════════════════════════════════════════════════
export const sqliteAccountGroups = sqliteTableBase(
  'shranix_account_groups',
  {
    ...sqliteBase,
...
export const pgAccountGroups = pgTableBase(
  'shranix_account_groups',
  {
    ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteChartOfAccounts = sqliteTableBase(
  'shranix_chart_of_accounts',
  {
    ...sqliteBase,
    ...
    isActive: sqliteInteger('is_active', { mode: 'boolean' }).notNull().default(true),
    costCenterRequired: sqliteInteger('cost_center_required', { mode: 'boolean' })
      .notNull()
      .default(false),
    gstApplicable: sqliteInteger('gst_applicable', { mode: 'boolean' }).notNull().default(false),
    bankReconciliation: sqliteInteger('bank_reconciliation', { mode: 'boolean' })
      .notNull()
      .default(false),
    isCashAccount: sqliteInteger('is_cash_account', { mode: 'boolean' }).notNull().default(false),
    isControlAccount: sqliteInteger('is_control_account', { mode: 'boolean' })
      .notNull()
      .default(false),
    allowManualPosting: sqliteInteger('allow_manual_posting', { mode: 'boolean' })
      .notNull()
      .default(true),
    description: sqliteText('description'),
  ...
  (table) => ({
    accountCodeIdx: uniqueIndex('acct_code_idx').on(table.accountCode),
    accountNameIdx: uniqueIndex('acct_name_idx').on(table.accountName),
  }),
);

export const pgChartOfAccounts = pgTableBase(
  'shranix_chart_of_accounts',
  {
    ...pgBase,
  ...
  (table) => ({
    accountCodeIdx: pgUniqueIndex('acct_code_idx').on(table.accountCode),
    accountNameIdx: pgUniqueIndex('acct_name_idx').on(table.accountName),
  }),
);
...
// 3. LEDGER MASTER
// ═════════════════════════════════════════════════════════
export const sqliteLedgerMaster = sqliteTableBase(
  'shranix_ledger_master',
  {
    ...sqliteBase,
...
export const pgLedgerMaster = pgTableBase(
  'shranix_ledger_master',
  {
    ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteJournalEntries = sqliteTableBase(
  'shranix_journal_entries',
  {
    ...sqliteBase,
  ...
  (table) => ({
    voucherNumberIdx: uniqueIndex('journal_voucher_number_idx').on(table.voucherNumber),
  }),
);

export const pgJournalEntries = pgTableBase(
  'shranix_journal_entries',
  {
    ...pgBase,
  ...
  (table) => ({
    voucherNumberIdx: pgUniqueIndex('journal_voucher_number_idx').on(table.voucherNumber),
  }),
);
...
// 5. CASH BOOK
// ═════════════════════════════════════════════════════════
export const sqliteCashBook = sqliteTableBase(
  'shranix_cash_book',
  {
    ...sqliteBase,
  ...
  (table) => ({
    cashBookDateIdx: uniqueIndex('cash_book_date_idx').on(table.cashAccountId, table.entryDate),
  }),
);

export const pgCashBook = pgTableBase(
  'shranix_cash_book',
  {
    ...pgBase,
  ...
  (table) => ({
    cashBookDateIdx: pgUniqueIndex('cash_book_date_idx').on(table.cashAccountId, table.entryDate),
  }),
);
...
// 6. BANK BOOK
// ═════════════════════════════════════════════════════════
export const sqliteBankBook = sqliteTableBase(
  'shranix_bank_book',
  {
    ...sqliteBase,
  ...
  (table) => ({
    bankBookDateIdx: uniqueIndex('bank_book_date_idx').on(table.bankAccountId, table.entryDate),
  }),
);

export const pgBankBook = pgTableBase(
  'shranix_bank_book',
  {
    ...pgBase,
  ...
  (table) => ({
    bankBookDateIdx: pgUniqueIndex('bank_book_date_idx').on(table.bankAccountId, table.entryDate),
  }),
);

// ═════════════════════════════════════════════════════════
// 6B. COMPANY BANK ACCOUNTS (Banking Settings)
// ═════════════════════════════════════════════════════════
export const sqliteBankAccounts = sqliteTableBase(
  'shranix_bank_accounts',
  {
    ...sqliteBase,
    companyId: sqliteText('company_id'),
    bankName: sqliteText('bank_name').notNull(),
    accountHolderName: sqliteText('account_holder_name'),
    accountNumber: sqliteText('account_number'),
    accountType: sqliteText('account_type').notNull().default('savings'), // savings, current, cash_credit, loan
    ifsc: sqliteText('ifsc'),
    swiftCode: sqliteText('swift_code'),
    upiId: sqliteText('upi_id'),
    chequeFormat: sqliteText('cheque_format'), // standard, custom
    isDefault: sqliteInteger('is_default', { mode: 'boolean' }).notNull().default(false),
    neftEnabled: sqliteInteger('neft_enabled', { mode: 'boolean' }).notNull().default(true),
    rtgsEnabled: sqliteInteger('rtgs_enabled', { mode: 'boolean' }).notNull().default(true),
    impsEnabled: sqliteInteger('imps_enabled', { mode: 'boolean' }).notNull().default(true),
    isActive: sqliteInteger('is_active', { mode: 'boolean' }).notNull().default(true),
    createdBy: sqliteText('created_by'),
    updatedBy: sqliteText('updated_by'),
  },
  (table) => ({ bankAcctCompanyIdx: sqliteIndex('bank_acct_company_idx').on(table.companyId) }),
);

export const pgBankAccounts = pgTableBase(
  'shranix_bank_accounts',
  {
    ...pgBase,
    companyId: pgUuid('company_id'),
    bankName: pgText('bank_name').notNull(),
    accountHolderName: pgText('account_holder_name'),
    accountNumber: pgText('account_number'),
    accountType: pgText('account_type').notNull().default('savings'),
    ifsc: pgText('ifsc'),
    swiftCode: pgText('swift_code'),
    upiId: pgText('upi_id'),
    chequeFormat: pgText('cheque_format'),
    isDefault: pgBoolean('is_default').notNull().default(false),
    neftEnabled: pgBoolean('neft_enabled').notNull().default(true),
    rtgsEnabled: pgBoolean('rtgs_enabled').notNull().default(true),
    impsEnabled: pgBoolean('imps_enabled').notNull().default(true),
    isActive: pgBoolean('is_active').notNull().default(true),
    createdBy: pgUuid('created_by'),
    updatedBy: pgUuid('updated_by'),
  },
  (table) => ({ bankAcctCompanyIdx: pgIndex('bank_acct_company_idx').on(table.companyId) }),
);

// ═════════════════════════════════════════════════════════
// 7. COST CENTERS
// ═════════════════════════════════════════════════════════
export const sqliteCostCenters = sqliteTableBase(
  'shranix_cost_centers',
  {
    ...sqliteBase,
    name: sqliteText('name').notNull(),
...
export const pgCostCenters = pgTableBase(
  'shranix_cost_centers',
  {
    ...pgBase,
    name: pgText('name').notNull(),
...
// ═════════════════════════════════════════════════════════
export const sqliteAccountingSettings = sqliteTableBase(
  'shranix_accounting_settings',
  {
    ...sqliteBase,
    companyId: sqliteText('company_id'),
    ...
    autoVoucherNumber: sqliteInteger('auto_voucher_number', { mode: 'boolean' })
      .notNull()
      .default(true),
    ...
    allowNegativeBalance: sqliteInteger('allow_negative_balance', { mode: 'boolean' })
      .notNull()
      .default(false),
    enforceDebitCreditEquality: sqliteInteger('enforce_debit_credit_equality', { mode: 'boolean' })
      .notNull()
      .default(true),
    ...
    currency: sqliteText('currency').notNull().default('INR'),
    // Financial Settings — locks & defaults (Settings Hub → Financial tab)
    fiscalYearLock: sqliteInteger('fiscal_year_lock', { mode: 'boolean' }).notNull().default(false),
    periodLock: sqliteInteger('period_lock', { mode: 'boolean' }).notNull().default(false),
    periodLockDate: sqliteText('period_lock_date'),
    voucherLock: sqliteInteger('voucher_lock', { mode: 'boolean' }).notNull().default(false),
    closingDate: sqliteText('closing_date'),
    openingBalanceLock: sqliteInteger('opening_balance_lock', { mode: 'boolean' })
      .notNull()
      .default(false),
    defaultLedgerAccountId: sqliteText('default_ledger_account_id'),
    defaultTaxGroupId: sqliteText('default_tax_group_id'),
    roundingRule: sqliteText('rounding_rule').notNull().default('nearest'),
  },
  (table) => ({
    acctSettingsCompanyIdx: uniqueIndex('acct_settings_company_idx').on(table.companyId),
  }),
);

export const pgAccountingSettings = pgTableBase(
  'shranix_accounting_settings',
  {
    ...pgBase,
    companyId: pgUuid('company_id'),
    ...
    currency: pgText('currency').notNull().default('INR'),
    // Financial Settings — locks & defaults (Settings Hub → Financial tab)
    fiscalYearLock: pgBoolean('fiscal_year_lock').notNull().default(false),
    periodLock: pgBoolean('period_lock').notNull().default(false),
    periodLockDate: pgText('period_lock_date'),
    voucherLock: pgBoolean('voucher_lock').notNull().default(false),
    closingDate: pgText('closing_date'),
    openingBalanceLock: pgBoolean('opening_balance_lock').notNull().default(false),
    defaultLedgerAccountId: pgUuid('default_ledger_account_id'),
    defaultTaxGroupId: pgUuid('default_tax_group_id'),
    roundingRule: pgText('rounding_rule').notNull().default('nearest'),
  },
  (table) => ({
    acctSettingsCompanyIdx: pgUniqueIndex('acct_settings_company_idx').on(table.companyId),
  }),
);

...
// 10. WAREHOUSE ZONES
// ═════════════════════════════════════════════════════════
export const sqliteWarehouseZones = sqliteTableBase('shranix_warehouse_zones', {
  ...sqliteBase,
...
export const pgWarehouseZones = pgTableBase('shranix_warehouse_zones', {
  ...pgBase,
...
// 11. WAREHOUSE RACKS
// ═════════════════════════════════════════════════════════
export const sqliteWarehouseRacks = sqliteTableBase('shranix_warehouse_racks', {
  ...sqliteBase,
...
export const pgWarehouseRacks = pgTableBase('shranix_warehouse_racks', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteWarehouseShelves = sqliteTableBase('shranix_warehouse_shelves', {
  ...sqliteBase,
...
export const pgWarehouseShelves = pgTableBase('shranix_warehouse_shelves', {
  ...pgBase,
...
// 13. WAREHOUSE BINS
// ═════════════════════════════════════════════════════════
export const sqliteWarehouseBins = sqliteTableBase('shranix_warehouse_bins', {
  ...sqliteBase,
...
export const pgWarehouseBins = pgTableBase('shranix_warehouse_bins', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteBatchMaster = sqliteTableBase('shranix_batch_master', {
  ...sqliteBase,
...
export const pgBatchMaster = pgTableBase('shranix_batch_master', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteBatchLots = sqliteTableBase('shranix_batch_lots', {
  ...sqliteBase,
...
export const pgBatchLots = pgTableBase('shranix_batch_lots', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteSerialMaster = sqliteTableBase('shranix_serial_master', {
  ...sqliteBase,
  ...
  manufacturerSerialIdx: uniqueIndex('serial_master_manufacturer_idx').on(table.manufacturerSerialNo),
  barcodeIdx: uniqueIndex('serial_master_barcode_idx').on(table.barcode),
}));

export const pgSerialMaster = pgTableBase('shranix_serial_master', {
  ...pgBase,
  ...
  manufacturerSerialIdx: pgUniqueIndex('serial_master_manufacturer_idx').on(table.manufacturerSerialNo),
...
// 19. SERIAL WARRANTY
// ═════════════════════════════════════════════════════════
export const sqliteSerialWarranty = sqliteTableBase('shranix_serial_warranty', {
  ...sqliteBase,
  serialId: sqliteText('serial_id').notNull(),
...
export const pgSerialWarranty = pgTableBase('shranix_serial_warranty', {
  ...pgBase,
  serialId: pgUuid('serial_id').notNull(),
...
// ═════════════════════════════════════════════════════════
export const sqliteSerialRMA = sqliteTableBase('shranix_serial_rma', {
  ...sqliteBase,
  serialId: sqliteText('serial_id').notNull(),
...
export const pgSerialRMA = pgTableBase('shranix_serial_rma', {
  ...pgBase,
  serialId: pgUuid('serial_id').notNull(),
...
// 17. UOM CONVERSIONS
// ═════════════════════════════════════════════════════════
export const sqliteUOMConversions = sqliteTableBase('shranix_uom_conversions', {
  ...sqliteBase,
  ...
  uomConvIdx: uniqueIndex('uom_conversion_idx').on(table.fromUnitId, table.toUnitId, table.itemId),
}));

export const pgUOMConversions = pgTableBase('shranix_uom_conversions', {
  ...pgBase,
  ...
  uomConvIdx: pgUniqueIndex('uom_conversion_idx').on(table.fromUnitId, table.toUnitId, table.itemId),
}));

// ═════════════════════════════════════════════════════════
// 15. PRODUCT ATTRIBUTES (Dynamic Attribute Engine)
// ═════════════════════════════════════════════════════════
export const sqliteProductAttributes = sqliteTableBase('shranix_product_attributes', {
  ...sqliteBase,
  itemId: sqliteText('item_id').notNull(),
  variantId: sqliteText('variant_id'),
...
export const pgProductAttributes = pgTableBase('shranix_product_attributes', {
  ...pgBase,
  itemId: pgUuid('item_id').notNull(),
  variantId: pgUuid('variant_id'),
...
// ═════════════════════════════════════════════════════════
export const sqliteInvStockLedger = sqliteTableBase('shranix_inv_stock_ledger', {
  id: sqliteText('id').primaryKey().$defaultFn(() => crypto.randomUUID()),
  createdAt: sqliteText('created_at').notNull().$defaultFn(() => new Date().toISOString()),
...
export const pgInvStockLedger = pgTableBase('shranix_inv_stock_ledger', {
  id: pgUuid('id').primaryKey().defaultRandom(),
  createdAt: pgTimestamp('created_at', { withTimezone: true }).notNull().defaultNow(),
...
// ═════════════════════════════════════════════════════════
export const sqliteInvStockBalance = sqliteTableBase('shranix_inv_stock_balance', {
  id: sqliteText('id').primaryKey().$defaultFn(() => crypto.randomUUID()),
  createdAt: sqliteText('created_at').notNull().$defaultFn(() => new Date().toISOString()),
  updatedAt: sqliteText('updated_at').notNull().$defaultFn(() => new Date().toISOString()).$onUpdateFn(() => new Date().toISOString()),
  itemId: sqliteText('item_id').notNull(),
...
export const pgInvStockBalance = pgTableBase('shranix_inv_stock_balance', {
  ...pgBase,
  itemId: pgUuid('item_id').notNull(),
  variantId: pgUuid('variant_id'),
  batchId: pgUuid('batch_id'),
...
// ═════════════════════════════════════════════════════════
export const sqliteInvStockReservation = sqliteTableBase('shranix_inv_stock_reservation', {
  ...sqliteBase,
...
export const pgInvStockReservation = pgTableBase('shranix_inv_stock_reservation', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteStockTransfers = sqliteTableBase('shranix_stock_transfers', {
  ...sqliteBase,
...
export const pgStockTransfers = pgTableBase('shranix_stock_transfers', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteStockAdjustments = sqliteTableBase('shranix_stock_adjustments', {
  ...sqliteBase,
...
export const pgStockAdjustments = pgTableBase('shranix_stock_adjustments', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteAdjustmentItems = sqliteTableBase('shranix_adjustment_items', {
  ...sqliteBase,
...
export const pgAdjustmentItems = pgTableBase('shranix_adjustment_items', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteTransferItems = sqliteTableBase('shranix_transfer_items', {
  ...sqliteBase,
  ...
  transferItemIdx: uniqueIndex('transfer_item_idx').on(table.transferId, table.itemId, table.batchNo),
}));

export const pgTransferItems = pgTableBase('shranix_transfer_items', {
  ...pgBase,
  ...
  transferItemIdx: pgUniqueIndex('transfer_item_idx').on(table.transferId, table.itemId, table.batchNo),
}));

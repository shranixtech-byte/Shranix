...
import { pgTable as pgTableBase, text as pgText, real as pgReal, uuid as pgUuid, timestamp as pgTimestamp, uniqueIndex as pgUniqueIndex, boolean as pgBoolean } from 'drizzle-orm/pg-core';
...
// ═════════════════════════════════════════════════════════
export const sqliteGlEntries = sqliteTableBase('shranix_gl_entries', {
  ...sqliteBase,
  ...
  glAccountIdx: uniqueIndex('gl_account_date_idx').on(table.accountId, table.entryDate),
  glVoucherIdx: uniqueIndex('gl_voucher_idx').on(table.voucherId),
}));

export const pgGlEntries = pgTableBase('shranix_gl_entries', {
  ...pgBase,
  ...
  glAccountIdx: pgUniqueIndex('gl_account_date_idx').on(table.accountId, table.entryDate),
  glVoucherIdx: pgUniqueIndex('gl_voucher_idx').on(table.voucherId),
}));

// ═════════════════════════════════════════════════════════
// 2. FINANCIAL SNAPSHOTS (Cached Report Data)
// ═════════════════════════════════════════════════════════
export const sqliteFinancialSnapshots = sqliteTableBase('shranix_financial_snapshots', {
  ...sqliteBase,
  ...
  snapshotTypeDateIdx: uniqueIndex('snapshot_type_date_idx').on(table.snapshotType, table.snapshotDate),
}));

export const pgFinancialSnapshots = pgTableBase('shranix_financial_snapshots', {
  ...pgBase,
  ...
  snapshotTypeDateIdx: pgUniqueIndex('snapshot_type_date_idx').on(table.snapshotType, table.snapshotDate),
}));

// ═════════════════════════════════════════════════════════
// 3. REPORT CACHE
// ═════════════════════════════════════════════════════════
export const sqliteReportCache = sqliteTableBase('shranix_report_cache', {
  ...sqliteBase,
...
export const pgReportCache = pgTableBase('shranix_report_cache', {
  ...pgBase,
...
// 4. POSTING RULES
// ═════════════════════════════════════════════════════════
export const sqlitePostingRules = sqliteTableBase('shranix_posting_rules', {
  ...sqliteBase,
...
export const pgPostingRules = pgTableBase('shranix_posting_rules', {
  ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteFiscalClosingRecords = sqliteTableBase('shranix_fiscal_closing_records', {
  ...sqliteBase,
  ...
  fiscalClosingFyIdx: uniqueIndex('fiscal_closing_fy_idx').on(table.financialYearId, table.closingType),
}));

export const pgFiscalClosingRecords = pgTableBase('shranix_fiscal_closing_records', {
  ...pgBase,
  ...
  fiscalClosingFyIdx: pgUniqueIndex('fiscal_closing_fy_idx').on(table.financialYearId, table.closingType),
}));

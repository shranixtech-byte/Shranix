...
// 1. GST REGISTRATIONS
// ═════════════════════════════════════════════════════════
export const sqliteGstRegistrations = sqliteTableBase(
  'shranix_gst_registrations',
  {
    ...sqliteBase,
...
export const pgGstRegistrations = pgTableBase(
  'shranix_gst_registrations',
  {
    ...pgBase,
...
// 2. GST LEDGER
// ═════════════════════════════════════════════════════════
export const sqliteGstLedger = sqliteTableBase(
  'shranix_gst_ledger',
  {
    ...sqliteBase,
  ...
  (table) => ({
    gstVoucherIdx: uniqueIndex('gst_voucher_idx').on(table.voucherType, table.voucherId),
  }),
);

export const pgGstLedger = pgTableBase(
  'shranix_gst_ledger',
  {
    ...pgBase,
  ...
  (table) => ({
    gstVoucherIdx: pgUniqueIndex('gst_voucher_idx').on(table.voucherType, table.voucherId),
  }),
);
...
// 3. GST RETURNS
// ═════════════════════════════════════════════════════════
export const sqliteGstReturns = sqliteTableBase(
  'shranix_gst_returns',
  {
    ...sqliteBase,
  ...
  (table) => ({
    gstReturnPeriodIdx: uniqueIndex('gst_return_period_idx').on(
      table.returnType,
      table.returnPeriod,
    ),
  }),
...
export const pgGstReturns = pgTableBase(
  'shranix_gst_returns',
  {
    ...pgBase,
  ...
  (table) => ({
    gstReturnPeriodIdx: pgUniqueIndex('gst_return_period_idx').on(
      table.returnType,
      table.returnPeriod,
    ),
  }),
...
// ═════════════════════════════════════════════════════════
export const sqliteYearClosingRecords = sqliteTableBase(
  'shranix_year_closing_records',
  {
    ...sqliteBase,
...
export const pgYearClosingRecords = pgTableBase(
  'shranix_year_closing_records',
  {
    ...pgBase,
...
// 6. PERIOD LOCKS
// ═════════════════════════════════════════════════════════
export const sqlitePeriodLocks = sqliteTableBase(
  'shranix_period_locks',
  {
    ...sqliteBase,
    financialYearId: sqliteText('financial_year_id').notNull(),
  ...
  (table) => ({
    periodLockKeyIdx: uniqueIndex('period_lock_key_idx').on(
...
export const pgPeriodLocks = pgTableBase(
  'shranix_period_locks',
  {
    ...pgBase,
    financialYearId: pgUuid('financial_year_id').notNull(),
  ...
  (table) => ({
    periodLockKeyIdx: pgUniqueIndex('period_lock_key_idx').on(
      table.financialYearId,
      table.periodType,
      table.periodKey,
    ),
...
// ═════════════════════════════════════════════════════════
export const sqliteOpeningBalanceTransfers = sqliteTableBase(
  'shranix_opening_balance_transfers',
  {
    ...sqliteBase,
...
export const pgOpeningBalanceTransfers = pgTableBase(
  'shranix_opening_balance_transfers',
  {
    ...pgBase,
...
// 8. YEAR-END ENTRIES
// ═════════════════════════════════════════════════════════
export const sqliteYearEndEntries = sqliteTableBase(
  ...
  (table) => ({
    yearEndEntryNumberIdx: uniqueIndex('year_end_entry_number_idx').on(table.entryNumber),
  }),
);

export const pgYearEndEntries = pgTableBase(
  'shranix_year_end_entries',
  {
    ...pgBase,
  ...
  (table) => ({
    yearEndEntryNumberIdx: pgUniqueIndex('year_end_entry_number_idx').on(table.entryNumber),
  }),
);
...
// 9. AUDIT DETAILS
// ═════════════════════════════════════════════════════════
export const sqliteAuditDetails = sqliteTableBase(
  'shranix_audit_details',
  {
    ...sqliteBase,
    ...
    // Regular (non-unique) index — audit writes can land in the same millisecond.
  },
  (table) => ({ auditTimestampIdx: sqliteIndex('audit_timestamp_idx').on(table.timestamp) }),
);

export const pgAuditDetails = pgTableBase(
  'shranix_audit_details',
  {
    ...pgBase,
  ...
  (table) => ({ auditTimestampIdx: pgIndex('audit_timestamp_idx').on(table.timestamp) }),
);

// ═════════════════════════════════════════════════════════
// 10. NUMBER SERIES
// ═════════════════════════════════════════════════════════
export const sqliteNumberSeries = sqliteTableBase(
  'shranix_number_series',
  {
    ...sqliteBase,
  ...
  (table) => ({
    seriesNameIdx: uniqueIndex('series_name_idx').on(table.seriesName),
    seriesCodeIdx: uniqueIndex('series_code_idx').on(table.seriesCode),
  }),
);

export const pgNumberSeries = pgTableBase(
  'shranix_number_series',
  {
    ...pgBase,
  ...
  (table) => ({
    seriesNameIdx: pgUniqueIndex('series_name_idx').on(table.seriesName),
    seriesCodeIdx: pgUniqueIndex('series_code_idx').on(table.seriesCode),
  }),
);
...
// ═════════════════════════════════════════════════════════
export const sqliteVoucherApprovals = sqliteTableBase(
  'shranix_voucher_approvals',
  {
    ...sqliteBase,
...
export const pgVoucherApprovals = pgTableBase(
  'shranix_voucher_approvals',
  {
    ...pgBase,
...
// ═════════════════════════════════════════════════════════
export const sqliteFinanceAnalytics = sqliteTableBase(
  'shranix_finance_analytics',
  {
    ...sqliteBase,
  ...
  (table) => ({
    analyticsPeriodIdx: uniqueIndex('analytics_period_idx').on(
      table.analyticsType,
      table.periodKey,
    ),
  }),
...
export const pgFinanceAnalytics = pgTableBase(
  'shranix_finance_analytics',
  {
    ...pgBase,
  ...
  (table) => ({
    analyticsPeriodIdx: pgUniqueIndex('analytics_period_idx').on(
      table.analyticsType,
      table.periodKey,
    ),
  }),
...
// ═════════════════════════════════════════════════════════
export const sqliteGstAuditSettings = sqliteTableBase(
  'shranix_gst_audit_settings',
  {
    ...sqliteBase,
...
export const pgGstAuditSettings = pgTableBase(
  'shranix_gst_audit_settings',
  {
    ...pgBase,

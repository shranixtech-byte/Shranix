...
export const USER_MODULES: ModuleDef[] = [
  ...
  { key: 'crm', label: 'CRM', emoji: '🤝', landingPath: '/crm/dashboard' },
  ...
  { key: 'hr', label: 'HR', emoji: '👥', landingPath: '/hr/dashboard' },
  { key: 'assets', label: 'Assets', emoji: '🏗️', landingPath: '/assets' },
  { key: 'expenses', label: 'Expenses', emoji: '🧾', landingPath: '/expenses' },
  { key: 'workflow', label: 'Workflow', emoji: '⚙️', landingPath: '/workflow/control' },
  {
    key: 'business_rules',
    label: 'Business Rules',
    emoji: '🛡️',
    landingPath: '/control/business-rules',
  },
  { key: 'portal', label: 'Customer Portal', emoji: '🌐', landingPath: '/portal-admin' },
  { key: 'commercial', label: 'Commercial', emoji: '💳', landingPath: '/commercial/dashboard' },
  { key: 'license', label: 'License', emoji: '🔑', landingPath: '/license/dashboard' },

...
export function CompaniesPage() {
    return (_jsx(MasterDataPage, { title: "Companies", description: "Manage your business entities and company profiles", columns: companyColumns, apiPath: "/companies", formFields: companyFields }));
}
// ── Financial Year ──────────────────────────────────────
const fyColumns = [
    { key: 'name', label: 'Name' },
...
export function FinancialYearsPage() {
    return (_jsx(MasterDataPage, { title: "Financial Years", description: "Configure financial periods for accounting cycles", columns: fyColumns, apiPath: "/financial-years", formFields: fyFields }));
}
// ── Branch ──────────────────────────────────────────────
const branchColumns = [
    { key: 'name', label: 'Name' },
...
export function BranchesPage() {
    return (_jsx(MasterDataPage, { title: "Branches", description: "Manage branch offices and regional locations", columns: branchColumns, apiPath: "/branches", formFields: branchFields }));
}
// ── Warehouse ───────────────────────────────────────────
...
export function WarehousesPage() {
    return (_jsx(MasterDataPage, { title: "Warehouses", description: "Manage storage locations, distribution centers, and inventory points", columns: warehouseColumns, apiPath: "/warehouses", formFields: warehouseFields }));
}
// ── Unit ────────────────────────────────────────────────
const unitColumns = [
    { key: 'name', label: 'Name' },
...
export function UnitsPage() {
    return (_jsx(MasterDataPage, { title: "Units", description: "Define measurement units for items and commodities", columns: unitColumns, apiPath: "/units", formFields: unitFields }));
}
// ── Category ────────────────────────────────────────────
...
export function CategoriesPage() {
    return (_jsx(MasterDataPage, { title: "Categories", description: "Organize items, parties, and transactions into categories", columns: categoryColumns, apiPath: "/categories", formFields: categoryFields }));
}
// ── Brand ───────────────────────────────────────────────
const brandColumns = [
    { key: 'name', label: 'Name' },
...
export function BrandsPage() {
    return (_jsx(MasterDataPage, { title: "Brands", description: "Manage product brands and manufacturers", columns: brandColumns, apiPath: "/brands", formFields: brandFields }));
}
// ── Tax Group ───────────────────────────────────────────
...
export function TaxGroupsPage() {
    return (_jsx(MasterDataPage, { title: "Tax Groups", description: "Configure tax categories and groupings", columns: taxGroupColumns, apiPath: "/tax-groups", formFields: taxGroupFields }));
}
// ── GST Rate ────────────────────────────────────────────
const gstRateColumns = [
    { key: 'name', label: 'Name' },
    { key: 'rate', label: 'Rate (%)' },
    { key: 'type', label: 'Type' },
    { key: 'igst', label: 'IGST' },
...
export function GSTRatesPage() {
    return (_jsx(MasterDataPage, { title: "GST Rates", description: "Configure GST tax slabs and rates for compliance", columns: gstRateColumns, apiPath: "/gst-rates", formFields: gstRateFields }));
}
// ── Form Page Exports ─────────────────────────────────────

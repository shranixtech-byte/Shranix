...
const customerColumns = [
    ...
    { key: 'status', label: 'Status', render: (v) => {
            ...
            return _jsx("span", { className: `inline-block rounded-full px-2.5 py-0.5 text-xs font-medium capitalize ${styles[v] || styles.active}`, children: v || 'active' });
        } },
];
...
export function CustomersPage() {
    return (_jsx(MasterDataPage, { title: "Customers", description: "Manage customer master with GST, contact, and credit information", columns: customerColumns, apiPath: "/customers", formFields: customerFields }));
}

...
export function ItemsPage() {
  return (
    <MasterDataPage
      title="Items"
      description="Enterprise item master with stock, pricing, GST, batch/serial tracking"
      columns={itemColumns}
...
export function ItemGroupsPage() {
  return (
    <MasterDataPage
      title="Item Groups"
      description="Group items for pricing and discount management"
...
export function ItemVariantsPage() {
  return (
    <MasterDataPage
      title="Item Variants"
      description="Manage product variations (size, color, pack size)"
      columns={variantColumns}
      apiPath="/inventory/variants"
      formFields={variantFields}
    />
  );
}
...
export function ItemPricingPage() {
  return (
    <MasterDataPage
      title="Item Pricing"
      description="Tiered pricing by price list, customer group, and quantity"
      columns={pricingColumns}
      apiPath="/inventory/pricing"
...
export function ItemBarcodesPage() {
  return (
    <MasterDataPage
      title="Item Barcodes & QR"
      description="Manage barcodes, QR codes, and scanning identifiers"
      columns={barcodeColumns}
      apiPath="/inventory/barcodes"
      formFields={barcodeFields}
    />
  );
}
...
export function HsnCodesPage() {
  return (
    <MasterDataPage
      title="HSN / SAC Codes"
      description="Harmonized System codes for GST compliance and customs"
      columns={hsnColumns}
      apiPath="/inventory/hsn-codes"
      formFields={hsnFields}
    />
  );
}
...
export function StockOpeningPage() {
  return (
    <MasterDataPage
      title="Stock Opening"
      description="Opening stock entries with batch, serial, and expiry details"
      columns={stockColumns}
      apiPath="/inventory/stock-opening"
      formFields={stockFields}
    />
  );
}
...
export function ItemImagesPage() {
  return (
    <MasterDataPage
      title="Item Images"
      description="Manage product images, thumbnails, and gallery"
      columns={imageColumns}
      apiPath="/inventory/images"

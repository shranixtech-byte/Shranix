...
export function WarehouseLocationsPage() {
    return (_jsx(MasterDataPage, { title: "Warehouse Locations", description: "Manage godowns, racks, shelves, and bins for precise inventory location tracking", columns: locationColumns, apiPath: "/inventory/warehouse-locations", formFields: locationFields }));
}
//# sourceMappingURL=warehouse-locations.js.map
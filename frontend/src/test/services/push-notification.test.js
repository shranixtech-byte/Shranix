...
mockNotify.permission = 'default';
mockNotify.requestPermission = vi.fn().mockResolvedValue('granted');
...
describe('Push Notification Service', () => {
    ...
    it('should show approval alert', () => {
        const shown = [];
        const showAlert = (docType, docNumber) => {
    ...
    it('should show low stock alert', () => {
        const shown = [];
        const showAlert = (item, stock, min) => {
    ...
    it('should show workflow alert', () => {
        const shown = [];
        const showAlert = (action, docType, docNumber) => {
...
//# sourceMappingURL=push-notification.test.js.map
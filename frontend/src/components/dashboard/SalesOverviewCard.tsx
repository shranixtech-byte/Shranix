...
const defaultWeeklyData: SalesDataPoint[] = [
  { date: '18 Aug', amount: 125000 },
  { date: '19 Aug', amount: 168000 },
  { date: '20 Aug', amount: 154000 },
  { date: '21 Aug', amount: 215000 },
  { date: '22 Aug', amount: 198000 },
  { date: '23 Aug', amount: 172000 },
  { date: '24 Aug', amount: 233400 },
];

const defaultMonthlyData: SalesDataPoint[] = [
  { date: 'Week 1', amount: 480000 },
  { date: 'Week 2', amount: 620000 },
  { date: 'Week 3', amount: 590000 },
  { date: 'Week 4', amount: 780000 },
];

const defaultYearlyData: SalesDataPoint[] = [
  { date: 'Q1', amount: 1850000 },
  { date: 'Q2', amount: 2420000 },
  { date: 'Q3', amount: 2890000 },
  { date: 'Q4', amount: 3650000 },
];
      ...
      <div className="flex items-center justify-between border-b border-slate-100/80 pb-1.5 dark:border-white/[0.06]">
        <div>
          <h3 className="font-poppins text-xs font-bold leading-none text-slate-900 sm:text-sm dark:text-white">
            विक्री आढावा{' '}
            <span className="text-xs font-normal text-slate-400">(Sales Overview)</span>
          </h3>
        </div>
                ...
                if (active && payload && payload.length) {
                  return (
                    <div className="shadow-xs rounded-lg border border-slate-200 bg-white/95 px-2.5 py-1.5 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/95">
                      ...
                      <p className="font-poppins text-xs font-extrabold text-emerald-600 dark:text-emerald-400">

...
|---|---|---|
| Master Project Report | [View](../reports/Master_Project_Report.md) | Release status tracked in phase reports |
| CHANGELOG.md | [View](../CHANGELOG.md) | Version history aligned with releases |
| Progress Dashboard | [View](../reports/Progress_Dashboard.md) | Release timeline tracked visually |

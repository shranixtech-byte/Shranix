...
import {
  ...
  UpdateItemBarcodeDto,
  CreateHsnCodeDto,
  UpdateHsnCodeDto,
  CreateStockOpeningDto,
  CreateItemImageDto,
  UpdateItemImageDto,
  CreateInventorySettingsDto,
  ...
  CreateDamageRegisterDto,
  UpdateDamageRegisterDto,
  CreateRecallRegisterDto,
  UpdateRecallRegisterDto,
  CreateDistributorReturnDto,
  UpdateDistributorReturnDto,
  ...
  CreateTransferDto,
  UpdateTransferDto,
  CreateBatchMasterDto,
  UpdateBatchMasterDto,
  CreateBatchLotDto,
  UpdateBatchLotDto,
  CreateBatchGenealogyDto,
  CreateSerialDto,
  UpdateSerialDto,
  CreateSerialWarrantyDto,
  UpdateSerialWarrantyDto,
...
export class ItemsController {
  ...
  async create(@Body() dto: CreateItemDto, @CurrentUser() u: { id: string }) {
  ...
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50, @Query('q') q?: string) {
    return this.service.findAll(Number(p), Number(ps), q);
  }
  @Get(':id')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  ...
  @ApiResponse({ status: 200, description: 'Item record' })
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async duplicate(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.duplicate(id, u?.id);
  }
}
...
export class ItemVariantsController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateItemVariantDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50, @Query('search') q?: string) {
    return this.service.findAll(Number(p), Number(ps), q);
  }
  @Get(':id')
  @Roles('admin', 'manager', 'accountant')
...
export class ItemGroupsController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateItemGroupDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - Pricing')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/pricing')
export class ItemPricingController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateItemPricingDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
export class ItemBarcodesController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateItemBarcodeDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - HSN Codes')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/hsn-codes')
export class HsnCodesController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateHsnCodeDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - Stock Opening')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/stock-opening')
export class StockOpeningController {
  ...
  @WorkflowDocument({
    ...
    templateCode: 'inventory-stock-opening',
    templateName: 'Stock Opening Workflow',
    amountField: 'totalAmount',
  })
  async create(@Body() dto: CreateStockOpeningDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  @Permissions('items.update')
  @HttpCode(HttpStatus.OK)
  async markPosted(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.update(id, { isPosted: true }, u?.id);
  }
  @Delete(':id')
  @Roles('admin')
  @Permissions('items.delete')
...
export class ItemImagesController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateItemImageDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - Batch Master')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/batch-master')
export class BatchMasterController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create batch master record' })
  @ApiResponse({ status: 201, description: 'Batch created' })
  async create(@Body() dto: CreateBatchMasterDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  @ApiResponse({ status: 200, description: 'Paginated batches' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50, @Query('q') q?: string) {
    return this.service.findAll(Number(p), Number(ps), q);
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Batch record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @Permissions('items.update')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Release batch' })
  @ApiResponse({ status: 200, description: 'Batch released' })
  async release(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.release(id, u?.id);
  }
  @Post(':id/block')
  @Roles('admin', 'manager')
  @Permissions('items.update')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Block batch' })
  @ApiResponse({ status: 200, description: 'Batch blocked' })
  async block(
    @Param('id') id: string,
    @Body() body: { reason: string },
    @CurrentUser() u: { id: string },
  ) {
    return this.service.block(id, body.reason, u?.id);
  }
  @Post(':id/quarantine')
  @Roles('admin', 'manager')
  @Permissions('items.update')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Quarantine batch' })
  @ApiResponse({ status: 200, description: 'Batch quarantined' })
  async quarantine(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.quarantine(id, u?.id);
  }
  @Get('select/:itemId/:warehouseId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'FEFO/FIFO batch selection engine' })
  @ApiResponse({ status: 200, description: 'Allocated batches' })
  async selectBatches(
    @Param('itemId') i: string,
    @Param('warehouseId') w: string,
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Expiry alerts dashboard' })
  @ApiResponse({ status: 200, description: 'Expired & near-expiry batches' })
  async getExpiryAlerts(@Query('days') days?: string) {
    return this.service.getExpiryAlerts(Number(days) || 30);
  }
}

// ── Step 18: Batch Lots ─────────────────────────────────
@ApiTags('Inventory - Batch Lots')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
...
export class BatchLotController {
  ...
  async create(@Body() dto: CreateBatchLotDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  @ApiResponse({ status: 200, description: 'Lot record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Split lot' })
  @ApiResponse({ status: 201, description: 'Lot split' })
  async split(
    @Param('id') id: string,
    @Body() body: { splitQuantity: number; newLotCode: string },
  ...
  @Permissions('items.update')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Merge lots' })
  @ApiResponse({ status: 200, description: 'Lots merged' })
  async merge(
    @Param('sourceId') s: string,
    @Param('targetId') t: string,
    @CurrentUser() _u: { id: string },
  ) {
...
@ApiTags('Inventory - Batch Genealogy')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/batch-genealogy')
export class BatchGenealogyController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create genealogy link' })
  @ApiResponse({ status: 201, description: 'Link created' })
  async create(@Body() dto: CreateBatchGenealogyDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get(':id')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get genealogy link' })
  @ApiResponse({ status: 200, description: 'Link record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
}
...
@ApiTags('Inventory - Batch Traceability')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/batch-trace')
export class BatchTraceController {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Forward trace (find child batches)' })
  @ApiResponse({ status: 200, description: 'Children tree' })
  async forwardTrace(@Param('batchId') id: string) {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Backward trace (find parent batches)' })
  @ApiResponse({ status: 200, description: 'Parent tree' })
  async backwardTrace(@Param('batchId') id: string) {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Full genealogy tree' })
  @ApiResponse({ status: 200, description: 'Full genealogy' })
  async fullGenealogy(@Param('batchId') id: string) {
    return this.service.fullGenealogy(id);
  }
}
...
export class SerialMasterController {
  ...
  @ApiResponse({ status: 201, description: 'Serial created' })
  async create(@Body() dto: CreateSerialDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'List serials' })
  @ApiResponse({ status: 200, description: 'Paginated serials' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50, @Query('q') q?: string) {
    return this.service.findAll(Number(p), Number(ps), q);
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Serial record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @ApiResponse({ status: 200, description: 'Serial deleted' })
  async delete(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.delete(id, u?.id);
  }
  @Get(':id/details')
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get serial details with warranty, installation, service, history' })
  @ApiResponse({ status: 200, description: 'Full serial details' })
  async getDetails(@Param('id') id: string) {
    return this.service.getSerialDetails(id);
  }
}

// ── Step 19: Serial Warranty ────────────────────────────
@ApiTags('Inventory - Serial Warranties')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-warranties')
export class SerialWarrantyController {
  ...
  @ApiResponse({ status: 201, description: 'Warranty created' })
  async create(@Body() dto: CreateSerialWarrantyDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  @ApiResponse({ status: 200, description: 'Paginated warranties' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Warranty record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @ApiResponse({ status: 200, description: 'Warranty updated' })
  async update(
    @Param('id') id: string,
    @Body() dto: UpdateSerialWarrantyDto,
    @CurrentUser() u: { id: string },
  ) {
    return this.service.update(id, dto, u?.id);
  }
  ...
  @ApiResponse({ status: 200, description: 'Warranty deleted' })
  async delete(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.delete(id, u?.id);
  }
}
...
@ApiTags('Inventory - Serial History')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-history')
export class SerialHistoryController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create history event' })
  @ApiResponse({ status: 201, description: 'Event created' })
  async create(@Body() dto: CreateSerialHistoryDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get('by-serial/:serialId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get history by serial' })
  @ApiResponse({ status: 200, description: 'Serial history' })
  async findBySerial(@Param('serialId') id: string) {
    return this.service.findAll(1, 100, id);
  }
}

// ── Step 19: Serial Relationships ───────────────────────
@ApiTags('Inventory - Serial Relationships')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-relationships')
export class SerialRelationshipController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create serial relationship' })
  @ApiResponse({ status: 201, description: 'Relationship created' })
  async create(@Body() dto: CreateSerialRelationshipDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get('children/:serialId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get child serials' })
  @ApiResponse({ status: 200, description: 'Child serials' })
  async findChildren(@Param('serialId') id: string) {
    return this.service.findAll(1, 100, id);
  }
}

// ── Step 19: Serial RMA ─────────────────────────────────
@ApiTags('Inventory - Serial RMA')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-rma')
export class SerialRMAController {
  ...
  async create(@Body() dto: CreateSerialRMADto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  @ApiResponse({ status: 200, description: 'Paginated RMAs' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'RMA record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @Permissions('items.update')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Update RMA' })
  @ApiResponse({ status: 200, description: 'RMA updated' })
  async update(
    @Param('id') id: string,
    @Body() dto: UpdateSerialRMADto,
    @CurrentUser() u: { id: string },
  ) {
    return this.service.update(id, dto, u?.id);
  }
...
@ApiTags('Inventory - Serial Service')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-service')
export class SerialServiceController {
  ...
  async create(@Body() dto: CreateSerialServiceDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get('by-serial/:serialId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get service history by serial' })
  @ApiResponse({ status: 200, description: 'Service history' })
  async findBySerial(@Param('serialId') id: string) {
    return this.service.findAll(1, 100, id);
  }
}
...
@ApiTags('Inventory - Serial Traceability')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-trace')
export class SerialTraceController {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Find child serials' })
  @ApiResponse({ status: 200, description: 'Child serials' })
  async findChildren(@Param('serialId') id: string) {
    return this.service.findChildren(id);
  }
  @Get('parents/:serialId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Find parent serials' })
  @ApiResponse({ status: 200, description: 'Parent serials' })
  async findParents(@Param('serialId') id: string) {
    return this.service.findParents(id);
  }
  @Get('history/:serialId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get serial history' })
  @ApiResponse({ status: 200, description: 'Full history' })
  async getHistory(@Param('serialId') id: string) {
    return this.service.getHistory(id);
  }
}

// ── Step 19: Serial Dashboard ───────────────────────────
@ApiTags('Inventory - Serial Dashboard')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/serial-dashboard')
export class SerialDashboardController {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Serial dashboard KPIs' })
...
@ApiTags('Inventory - Batch Dashboard')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/batch-dashboard')
export class BatchDashboardController {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Batch dashboard KPIs' })
  @ApiResponse({ status: 200, description: 'Dashboard metrics' })
  async getDashboard() {
    return this.service.getDashboard();
  }
...
export class BatchStockController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateBatchDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Record opening stock entry' })
  @ApiResponse({ status: 201, description: 'Opening stock recorded' })
  ...
  async adjustStock(
    @Param('id') id: string,
    @Body()
    body: { type: 'increase' | 'decrease'; quantity: number; reason: string; remarks?: string },
    @CurrentUser() u: { id: string },
  ) {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get live stock snapshot' })
  @ApiResponse({ status: 200, description: 'Live stock data' })
...
export class StockLedgerController {
  ...
  @ApiResponse({ status: 200, description: 'Filtered stock movements' })
  async getLedger(
    @Query('page') page?: number,
    @Query('pageSize') ps?: number,
...
export class StockMovementController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateStockMovementDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - Warehouse Locations')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
...
export class WarehouseLocationController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateWarehouseLocationDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - Damage Register')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/damage-register')
export class DamageRegisterController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateDamageRegisterDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  async update(
    @Param('id') id: string,
    @Body() dto: UpdateDamageRegisterDto,
    @CurrentUser() u: { id: string },
  ) {
    return this.service.update(id, dto, u?.id);
  }
...
@ApiTags('Inventory - Recall Register')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/recall-register')
export class RecallRegisterController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateRecallRegisterDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  async update(
    @Param('id') id: string,
    @Body() dto: UpdateRecallRegisterDto,
    @CurrentUser() u: { id: string },
  ) {
    return this.service.update(id, dto, u?.id);
  }
...
@ApiTags('Inventory - Distributor Returns')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/distributor-returns')
export class DistributorReturnController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateDistributorReturnDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  async update(
    @Param('id') id: string,
    @Body() dto: UpdateDistributorReturnDto,
    @CurrentUser() u: { id: string },
  ) {
    return this.service.update(id, dto, u?.id);
  }
...
@ApiTags('Inventory - Replacement Queue')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/replacement-queue')
export class ReplacementQueueController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateReplacementDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
@ApiTags('Inventory - Sub Categories')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
...
export class SubCategoriesController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateSubCategoryDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
...
export class StockTransferController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() dto: CreateTransferDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager', 'accountant')
  ...
  async reject(
    ...
    return this.service.reject(id, body.reason, u?.id);
  }
}

// ── Step 16: Warehouse Zones ─────────────────────────────
@ApiTags('Inventory - Warehouse Zones')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
...
export class WarehouseZonesController {
  ...
  @ApiResponse({ status: 200, description: 'Paginated zones' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Zone record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
...
@ApiTags('Inventory - Warehouse Racks')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
...
export class WarehouseRacksController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create warehouse rack' })
  @ApiResponse({ status: 201, description: 'Rack created' })
  async create(@Body() dto: any, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'List warehouse racks' })
  @ApiResponse({ status: 200, description: 'Paginated racks' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Rack record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @ApiResponse({ status: 200, description: 'Rack updated' })
  async update(@Param('id') id: string, @Body() dto: any, @CurrentUser() u: { id: string }) {
    return this.service.update(id, dto, u?.id);
  }
  @Delete(':id')
  ...
  @ApiResponse({ status: 200, description: 'Rack deleted' })
  async delete(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.delete(id, u?.id);
  }
}

@ApiTags('Inventory - Warehouse Shelves')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/shelves')
export class WarehouseShelvesController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create warehouse shelf' })
  @ApiResponse({ status: 201, description: 'Shelf created' })
  async create(@Body() dto: any, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'List warehouse shelves' })
  @ApiResponse({ status: 200, description: 'Paginated shelves' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Shelf record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @ApiResponse({ status: 200, description: 'Shelf updated' })
  async update(@Param('id') id: string, @Body() dto: any, @CurrentUser() u: { id: string }) {
    return this.service.update(id, dto, u?.id);
  }
  @Delete(':id')
  ...
  @ApiResponse({ status: 200, description: 'Shelf deleted' })
  async delete(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.delete(id, u?.id);
  }
}

@ApiTags('Inventory - Warehouse Bins')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/bins')
export class WarehouseBinsController {
  ...
  @ApiResponse({ status: 200, description: 'Paginated bins' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Bin record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @ApiResponse({ status: 200, description: 'Bin deleted' })
  async delete(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.delete(id, u?.id);
  }
}
...
@ApiTags('Inventory - Warehouse Dashboard')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/warehouse-dashboard')
...
@ApiTags('Inventory - Warehouse Stock')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/warehouse-stock')
export class WarehouseStockController {
  ...
  @ApiResponse({ status: 200, description: 'Stock by warehouse' })
  async getStock(@Query('warehouseId') warehouseId?: string) {
    return this.service.getWarehouseStock(warehouseId);
  }
}

// ── PRM-015C: Warehouse Enterprise Search ────────────────
@ApiTags('Inventory - Warehouse Search')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/warehouse-search')
export class WarehouseSearchController {
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Global warehouse search' })
...
@ApiTags('Inventory - UOM Conversions')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/uom-conversions')
export class UOMConversionsController {
  ...
  @ApiResponse({ status: 200, description: 'Paginated conversions' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Conversion record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @ApiResponse({ status: 200, description: 'Conversion updated' })
  async update(@Param('id') id: string, @Body() dto: any, @CurrentUser() u: { id: string }) {
    return this.service.update(id, dto, u?.id);
  }
  @Delete(':id')
  ...
  @ApiResponse({ status: 200, description: 'Conversion deleted' })
  async delete(@Param('id') id: string, @CurrentUser() u: { id: string }) {
    return this.service.delete(id, u?.id);
  }
  @Get('convert/:fromUnitId/:toUnitId')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  ...
  async convert(
    @Param('fromUnitId') f: string,
    @Param('toUnitId') t: string,
    @Query('qty') qty: string,
    @Query('itemId') itemId?: string,
  ) {
...
@ApiTags('Inventory - Product Attributes')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/product-attributes')
export class ProductAttributesController {
  ...
  @ApiResponse({ status: 200, description: 'Paginated attributes' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get('by-item/:itemId')
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get attributes by item' })
  @ApiResponse({ status: 200, description: 'Item attributes' })
  async findByItem(@Param('itemId') itemId: string) {
    return this.service.getAttributesByItem(itemId);
  }
  @Get(':id')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  ...
  @ApiResponse({ status: 200, description: 'Attribute record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
...
@ApiTags('Inventory - Item Packaging')
@ApiBearerAuth('access-token')
@UseGuards(JwtAuthGuard)
@Controller('inventory/packaging')
export class ItemPackagingController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create packaging entry' })
  ...
  @ApiResponse({ status: 200, description: 'Paginated packaging' })
  async findAll(@Query('page') p = 1, @Query('ps') ps = 50) {
    return this.service.findAll(Number(p), Number(ps));
  }
  @Get('by-item/:itemId')
  ...
  @Permissions('items.read')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get packaging by item' })
  @ApiResponse({ status: 200, description: 'Item packaging' })
  async findByItem(@Param('itemId') itemId: string) {
    return this.service.getPackagingByItem(itemId);
  }
  @Get(':id')
  @Roles('admin', 'manager', 'accountant')
  @Permissions('items.read')
  ...
  @ApiResponse({ status: 200, description: 'Packaging record' })
  async findOne(@Param('id') id: string) {
    return this.service.findById(id);
  }
  @Put(':id')
  ...
  @Permissions('items.delete')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Delete packaging' })
...
export class InventorySettingsController {
  ...
  @Permissions('items.create')
  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ summary: 'Create inventory settings' })
  @ApiResponse({ status: 201, description: 'Settings created' })
  async create(@Body() dto: CreateInventorySettingsDto, @CurrentUser() u: { id: string }) {
    return this.service.create(dto, u?.id);
  }
  @Get()
  @Roles('admin', 'manager')
  ...
  async getSettings() {
    return this.service.findAll(1, 1);
  }
  @Put()
  @Roles('admin')
  @Permissions('items.update')

...
export class EnterpriseTransferController {
  ...
  async create(@Body() dto: CreateTransferDocumentDto, @CurrentUser() u: {id:string}) {
    return this.transferService.createTransfer({ ...dto, items: dto.items.map(i => ({ ...i })), createdBy: u?.id });
  }
  ...
  async approve(@Param('id') id: string, @Body() dto: ApproveTransferDto, @CurrentUser() u: {id:string}) {
  ...
  async markInTransit(@Param('id') id: string, @Body() dto: InTransitTransferDto, @CurrentUser() u: {id:string}) {
  ...
  async receive(@Body() dto: ReceiveTransferDto, @CurrentUser() u: {id:string}) {
    return this.transferService.receiveTransfer({ id: dto.id, items: dto.items?.map(i => ({ ...i })), userId: u?.id });
  }
  ...
  async reject(@Param('id') id: string, @Body() dto: RejectTransferDto, @CurrentUser() u: {id:string}) {
  ...
  async cancel(@Param('id') id: string, @Body() dto: CancelTransferDto, @CurrentUser() u: {id:string}) {
